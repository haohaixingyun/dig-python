...
class FastPass_Mobile(unittest.TestCase):
	...
	C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','ESA_VerifyLink_Customers_p1')
	...
	C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','ESA_VerifyLink_Customers_p2')
	...
	driver.find_element_by_name("ibm-submit").submit()
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','ESA_VerifyLink_Customers_p3')
        time.sleep(3)
	...
	result = driver.title
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','ESA_VerifyLink_Customers_p4')
        time.sleep(3)
	...
	result = driver.title
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','ESA_VerifyLink_Customers_p5')
        time.sleep(3)
	...
	result = driver.title
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','ESA_VerifyLink_Customers_p6')
        time.sleep(3)
...
#	driver.execute_script("window.scrollBy(0,200)","")
	...
	result = driver.title
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','ESA_VerifyLink_Customers_p7')
        time.sleep(3)
...
#	driver.execute_script("window.scrollBy(0,200)","")
	...
	result = driver.title
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','ESA_VerifyLink_Customers_p8')
        time.sleep(3)
	...
	result = driver.title
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','ESA_VerifyLink_Customers_p9')
        time.sleep(3)
...
#	driver.execute_script("window.scrollBy(0,1000)","")
	...
	result = driver.title
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','ESA_VerifyLink_Customers_p10')
        time.sleep(3)
...
#	driver.execute_script("window.scrollBy(0,1000)","")
	...
	result = driver.title
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','ESA_VerifyLink_Customers_p11')
        time.sleep(3)
...
#	driver.execute_script("window.scrollBy(0,1000)","")
	...
	result = driver.title
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','ESA_VerifyLink_Customers_p12')
        time.sleep(3)
...
#	driver.execute_script("window.scrollBy(0,1000)","")
	...
	result = driver.title
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','ESA_VerifyLink_Customers_p13')
        time.sleep(3)
...
#	driver.execute_script("window.scrollBy(0,1000)","")
	...
	result = driver.title
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','ESA_VerifyLink_Customers_p14')
        time.sleep(3)
	...
	driver.find_element_by_name("ibm-submit").submit()
        ...
        assert result == 'FastPass | Customers - Customer information - Default sort by customer name' ,"The page did not be opened correct"
        assert 'Embedded Solution Agreement indicator:' in driver.page_source," ESA did not show in page"
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','ESA_VerifyLink_Customers_p15')
        time.sleep(3)        
	...
	driver.find_element_by_name("ibm-submit").submit()
        ...
        assert result == 'FastPass | Customers - Customer details' ,"The page did not be opened correct"
        assert 'Embedded Solution Agreement indicator:' in driver.page_source," ESA did not show in page"
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','ESA_VerifyLink_Customers_p16')
        time.sleep(3)
...
if __name__ == '__main__':
    ...
    fp=file(filename,'wb')
    runner = HTMLTestRunner.HTMLTestRunner(stream=fp,title='FastPass_Mobile Test Case',description='This is ESA_VerifyLink_Customers test case')
    runner.run(testunit)
