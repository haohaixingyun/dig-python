...
class FastPass_Mobile(unittest.TestCase):
	...
	C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','SaasSolution_p1')
	...
	C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','SaasSolution_p2')
	...
	driver.implicitly_wait(10)
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','SaasSolution_p3')
        time.sleep(3)
	...
	result = driver.title
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','SaasSolution_p4')
	time.sleep(3)
	...
	time.sleep(3)
        ...
        assert 'SaaS Solution Provider' in driver.page_source , "The data is not avalible"
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','SaasSolution_p5')
        time.sleep(3)
...
#	driver.execute_script("window.scrollBy(0,300)","")
	...
	result = driver.title
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','SaasSolution_p6')
        time.sleep(5)
	...
	driver.execute_script("window.scroll(0,0)","")
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','SaasSolution_p7')
        time.sleep(3)
	...
	time.sleep(3)
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','SaasSolution_p8')
        time.sleep(3)
	...
	time.sleep(3)
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','SaasSolution_p9')
        time.sleep(3)
	...
	time.sleep(3)
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','SaasSolution_p10')
	...
	time.sleep(3)
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','SaasSolution_p11')
	...
	time.sleep(3)
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','SaasSolution_p12')
	...
	time.sleep(3)
        ...
        assert result == 'FastPass | Agreements - Agreement details' ,"The page did not be opened correct"
        assert 'SaaS Solution Provider' in driver.page_source , "The data is not avalible"
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','SaasSolution_p13')
        time.sleep(3)
...
#	driver.execute_script("window.scrollBy(0,300)","")
	...
	result = driver.title
        assert result == 'FastPass | Customers - Customer details' ,"The page did not be opened correct"
        assert 'SaaS Solution Provider provider' in driver.page_source , "The data is not avalible"
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','SaasSolution_p14')
        time.sleep(5)
	...
	driver.execute_script("window.scroll(0,0)","")
        ...
        result = driver.title
        assert result == 'FastPass | Customers - Contact information' ,"The page did not be opened correct"
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','SaasSolution_p15')
        time.sleep(3)
	...
	time.sleep(3)
        ...
        result = driver.title
        assert result == 'FastPass | Sales orders - Current sales order' ,"The page did not be opened correct"
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','SaasSolution_p16')
        time.sleep(3)
	...
	time.sleep(3)
        ...
        result = driver.title
        assert result == 'FastPass | Sales orders - Site historical information' ,"The page did not be opened correct"
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','SaasSolution_p17')
        time.sleep(3)
	...
	time.sleep(3)
        ...
        result = driver.title
        assert result == 'FastPass | Entitlements - Customer site entitlement information' ,"The page did not be opened correct"
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','SaasSolution_p18')
	...
	time.sleep(3)
        ...
        result = driver.title
        assert result == 'FastPass | Sales orders - Services agreements by site' ,"The page did not be opened correct"
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','SaasSolution_p19')
...
#        assert 'SaaS Solution Provider' in driver.page_souce ,"The data is not avalible" 
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','SaasSolution_p20')        
	...
	time.sleep(3)
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','SaasSolution_p21')
	...
	time.sleep(3)
        ...
        assert 'SaaS Solution Provider' in driver.page_souce ,"The data is not avalible"
        assert 'End user' in driver.page_souce ,"The data is not avalible"
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','SaasSolution_p22')
	...
	time.sleep(3)
        ...
        assert 'SaaS Solution Provider' in driver.page_souce ,"The data is not avalible"
        assert 'End user' in driver.page_souce ,"The data is not avalible"
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','SaasSolution_p23')
	...
	time.sleep(3)
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','SaasSolution_p24')
	...
	time.sleep(3)
        ...
        assert 'SaaS Solution Provider' in driver.page_souce ,"The data is not avalible"
        assert 'Provider' in driver.page_souce ,"The data is not avalible"
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','SaasSolution_p25')
	...
	time.sleep(3)
        ...
        assert 'SaaS Solution Provider' in driver.page_souce ,"The data is not avalible"
        assert 'Provider' in driver.page_souce ,"The data is not avalible"
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','SaasSolution_p26')
...
if __name__ == '__main__':
    ...
    testunit.addTest(FastPass_Mobile("test_Case_SaasSolution"))
    filename="C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\"+now+" FastPass_Test_Case_SaasSolution.html"
    fp=file(filename,'wb')
    runner = HTMLTestRunner.HTMLTestRunner(stream=fp,title='FastPass_Mobile Test Case',description='This is SaasSolution test case')
    runner.run(testunit)
