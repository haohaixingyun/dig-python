...
class FastPass_Mobile(unittest.TestCase):
	...
	C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','NewRelease144_1_p1')
        time.sleep(3)	
	...
	C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','NewRelease144_1_p2')
	...
	driver.find_element_by_name("ibm-submit").submit()
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','NewRelease144_1_p3')
        time.sleep(3)
	...
	driver.back()
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','NewRelease144_1_p4')
        time.sleep(3)
	...
	driver.find_element_by_name("ibm-submit").submit()
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','NewRelease144_1_p5')
        time.sleep(3)
	...
	print now_url
	assert now_url == 'http://sbybz2239.sby.ibm.com:19080/FastPassS2/fastpass.html' ,"URL is not correct."
	C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','NewRelease144_2_p1')
        time.sleep(3)	
	...
	C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','NewRelease144_2_p2')
	driver.find_element_by_name("submit").click()
	driver.implicitly_wait(10)
	...
	driver.find_element_by_name("ibm-submit").submit()
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','NewRelease144_2_p3')
        time.sleep(3)
	...
	driver.back()
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','NewRelease144_2_p4')
        time.sleep(3)
	...
	driver.find_element_by_name("ibm-submit").submit()
        ...
        result = driver.title
        assert result == 'FastPass | Agreements - Agreement details' ,"The page did not be opened correct"
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','NewRelease144_2_p5')
        time.sleep(3)
	...
	print now_url
	assert now_url == 'http://sbybz2239.sby.ibm.com:19080/FastPassS2/fastpass.html' ,"URL is not correct."
	C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','NewRelease144_3_p1')
        time.sleep(3)	
	...
	print "step2.login"
	login.login(self,'Agreements')
	C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','NewRelease144_3_p2')
	driver.find_element_by_name("submit").click()
	driver.implicitly_wait(10)
	...
	driver.find_element_by_name("ibm-submit").submit()
        ...
        result = driver.title
        assert result == 'FastPass | Agreements - Agreement details' ,"The page did not be opened correct"
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','NewRelease144_3_p3')
        time.sleep(3)
	...
	time.sleep(3)
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','NewRelease144_3_p4')
        time.sleep(3)
	...
	driver.find_element_by_xpath("//a[contains(text(),'0055146989')]").click()
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','NewRelease144_3_p5')
        time.sleep(3)
	...
	driver.find_element_by_xpath("//a[contains(text(),'0055146989')]").click()
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','NewRelease144_3_p6')
        time.sleep(3)
	...
	print now_url
	assert now_url == 'http://sbybz2239.sby.ibm.com:19080/FastPassS2/fastpass.html' ,"URL is not correct."
	C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','NewRelease144_4_p1')
	...
	print "step2.login"
	login.login(self,'Agreements')
	C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','NewRelease144_4_p2')
	driver.find_element_by_name("submit").click()
	driver.implicitly_wait(10)
	...
	driver.find_element_by_name("ibm-submit").submit()
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','NewRelease144_4_p3')
	...
	driver.find_element_by_name("ibm-submit").submit()
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','NewRelease144_4_p4')
...
if __name__ == '__main__':
    ...
    testunit.addTest(FastPass_Mobile("test_Case144_1"))
    testunit.addTest(FastPass_Mobile("test_Case144_2"))
    testunit.addTest(FastPass_Mobile("test_Case144_3"))
    testunit.addTest(FastPass_Mobile("test_Case144_4"))
    filename="C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\"+now+" FastPass_Test_Case_NewRelease144.html"
    fp=file(filename,'wb')
    runner = HTMLTestRunner.HTMLTestRunner(stream=fp,title='FastPass_Mobile Test Case',description='This is NewRelease144 test case')
    runner.run(testunit)
