...
class FastPass_Mobile(unittest.TestCase):
	...
	C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','ESA_VerifyLink_Agreements_p1')
	...
	C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','ESA_VerifyLink_Agreements_p2')
...
#	driver.execute_script("window.scrollBy(0,document.body.scrollHeight)","")
	...
	driver.implicitly_wait(10)
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','ESA_VerifyLink_Agreements_p3')
        time.sleep(3)
	...
	assert result == 'FastPass | Agreements - Agreement site information' ,"The page did not be opened correct"
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','ESA_VerifyLink_Agreements_p4')
        time.sleep(3)
	...
	result = driver.title
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','ESA_VerifyLink_Agreements_p5')
        time.sleep(3)
	...
	result = driver.title
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','ESA_VerifyLink_Agreements_p6')
        time.sleep(3)
	...
	result = driver.title
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','ESA_VerifyLink_Agreements_p7')
        time.sleep(3)
	...
	result = driver.title
        assert result == 'FastPass | Agreements - Agreement search information - Default sort by customer name' ,"The page did not be opened correct"
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','ESA_VerifyLink_Agreements_p8')
        time.sleep(3)
...
#	driver.execute_script("window.scrollBy(0,200)","")
	...
	result = driver.title
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','ESA_VerifyLink_Agreements_p9')
        time.sleep(3)
...
#	driver.execute_script("window.scrollBy(0,200)","")
	...
	result = driver.title
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','ESA_VerifyLink_Agreements_p10')
        time.sleep(3)
	...
	result = driver.title
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','ESA_VerifyLink_Agreements_p11')
        time.sleep(3)
...
#	driver.execute_script("window.scrollBy(0,1000)","")
	...
	result = driver.title
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','ESA_VerifyLink_Agreements_p12')
        time.sleep(3)
...
#	driver.execute_script("window.scrollBy(0,1000)","")
	...
	result = driver.title
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','ESA_VerifyLink_Agreements_p13')
        time.sleep(3)
...
#	driver.execute_script("window.scrollBy(0,1000)","")
	...
	result = driver.title
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','ESA_VerifyLink_Agreements_p14')
        time.sleep(3)
...
if __name__ == '__main__':
    ...
    testunit.addTest(FastPass_Mobile("test_Case_ESA_VerifyLink_Agreements"))
    filename="C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\"+now+" FastPass_Test_Case_ESA_VerifyLink_Agreements.html"
    fp=file(filename,'wb')
    runner = HTMLTestRunner.HTMLTestRunner(stream=fp,title='FastPass_Mobile Test Case',description='This is ESA_VerifyLink_Agreements test case')
    runner.run(testunit)
