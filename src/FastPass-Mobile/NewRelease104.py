...
class FastPass_Mobile(unittest.TestCase):
	...
	C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','NewRelease104_p1')
	...
	C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','NewRelease104_p2')
	...
	driver.implicitly_wait(10)
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','NewRelease104_p3')
        time.sleep(3)
...
#	driver.execute_script("window.scrollBy(0,document.body.scrollHeight)","")
	driver.implicitly_wait(10)
        ...
        assert 'Services agreement number:' in driver.page_source ,"The data is not available"
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','NewRelease104_p4')
        time.sleep(3)
...
#	driver.execute_script("window.scrollBy(0,document.body.scrollHeight)","")
	driver.implicitly_wait(10)
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','NewRelease104_p5')
        time.sleep(3)
	...
	print "step6.Select dropdown option 'All Entitlements' and hit Go button. "
        ...
        Select(sel).select_by_value('/FastPassS2/page/EntitlemtAllForSAPID?cust_num=0003464947&sap_ctrct_num=NAV&cust_type=NAV&program=PX')
	...
	result = driver.title
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','NewRelease104_p6')
        time.sleep(3)
	...
	result = driver.title
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','NewRelease104_p7')
        time.sleep(3)
	...
	time.sleep(2)
	result = driver.title
        assert result == 'FastPass | Entitlements - All entitlements for site'
	...
	result = driver.title
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','NewRelease104_p8')        
	...
	result = driver.title
        assert result == 'FastPass | Entitlements - Part information' ,"The page did not be opened correct"
        assert 'D0NQBLL' in driver.page_source,"The page did not be opened correct"
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','NewRelease104_p9')
        time.sleep(3)
	...
	time.sleep(2)
	result = driver.title
        assert result == 'FastPass | Entitlements - All sales orders for site'
...
#	driver.execute_script("window.scrollBy(0,400)","")	
	...
	result = driver.title
        assert result == 'FastPass | Sales orders - Services agreement' ,"The page did not be opened correct"
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','NewRelease104_p10')
        time.sleep(3)
	...
	result = driver.title
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','NewRelease104_p11')
        time.sleep(3)
	...
	result = driver.title
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','NewRelease104_p12')
        time.sleep(3)
	...
	result = driver.title
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','NewRelease104_p13')
        time.sleep(3)
	...
	time.sleep(2)
	result = driver.title
        assert result == 'FastPass | Agreements - Agreement details'
        time.sleep(3)
	...
	result = driver.title
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','NewRelease104_p14')
...
if __name__ == '__main__':
    ...
    testunit.addTest(FastPass_Mobile("test_Case_NewRelease104"))
    filename="C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\"+now+" FastPass_Test_Case_NewRelease104.html"
    fp=file(filename,'wb')
    runner = HTMLTestRunner.HTMLTestRunner(stream=fp,title='FastPass_Mobile Test Case',description='This is NewRelease104 test case')
    runner.run(testunit)
