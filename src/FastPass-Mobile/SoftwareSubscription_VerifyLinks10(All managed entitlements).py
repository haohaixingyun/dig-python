...
class FastPass_Mobile(unittest.TestCase):
    ...
    def test_Case_SoftwareSubscription_VerifyLinks10(self):
	...
	C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','SoftwareSubscription_VerifyLinks10_p1')
	...
	C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','SoftwareSubscription_VerifyLinks10_p2')
...
#	driver.execute_script("window.scrollBy(0,document.body.scrollHeight)","")
	...
	driver.implicitly_wait(10)
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','SoftwareSubscription_VerifyLinks10_p3')
        time.sleep(3)

	print "\n"
	print "step4.Select dropdown option 'All sales transactions' and hit Go button. "
        sel = driver.find_element_by_xpath("//select[@id='dropList1']")
        Select(sel).select_by_value('./EntitlemtMngdEmntsAllForSAPID?openagent&agree_num=0000009382&program=PA&ibm_cust_num=7824737&cust_type=NAV&cust_num=0007017541')
	...
	result = driver.title
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','SoftwareSubscription_VerifyLinks10_p4')
        time.sleep(3)
	...
	result = driver.title
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','SoftwareSubscription_VerifyLinks10_p5')
        time.sleep(3)
	...
	result = driver.title
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','SoftwareSubscription_VerifyLinks10_p6')
        time.sleep(3)
	...
	result = driver.title
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','SoftwareSubscription_VerifyLinks10_p7')
        time.sleep(3)
	...
	time.sleep(1)
	driver.find_element_by_xpath("//a[contains(text(),'D1GANLL')]").click()
	driver.implicitly_wait(10)
	time.sleep(3)
	result = driver.title
        assert result == 'FastPass | Entitlements - Part information' ,"The page did not be opened correct"
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','SoftwareSubscription_VerifyLinks10_p8')
        time.sleep(3)
...
#	driver.execute_script("window.scrollBy(0,800)","")
	time.sleep(1)
	driver.find_element_by_xpath("(//a[contains(text(),'0055530786')])[1]").click()
	driver.implicitly_wait(10)
	time.sleep(3)
	result = driver.title
        assert result == 'FastPass | Sales orders - Sales order information' ,"The page did not be opened correct"
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','SoftwareSubscription_VerifyLinks10_p9')
        time.sleep(3)
	...
	result = driver.title
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','SoftwareSubscription_VerifyLinks10_p10')
        time.sleep(3)
	...
	result = driver.title
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','SoftwareSubscription_VerifyLinks10_p11')
        time.sleep(3)        
...
#	driver.execute_script("window.scroll(0,0)","")
	...
	result = driver.title
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','SoftwareSubscription_VerifyLinks10_p12')
        time.sleep(3)        
...
#	driver.execute_script("window.scroll(0,0)","")
	...
	result = driver.title
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','SoftwareSubscription_VerifyLinks10_p13')
        time.sleep(3)        
...
#	driver.execute_script("window.scroll(0,0)","")
	...
	result = driver.title
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','SoftwareSubscription_VerifyLinks10_p14')
        time.sleep(3)        
	...
	result = driver.title
        ...
        print "\n"
	print "step25.Click on 'All sales transactions' in the related links area."
#	driver.execute_script("window.scroll(0,0)","")
	time.sleep(1)
	...
	result = driver.title
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','SoftwareSubscription_VerifyLinks10_p15')
        time.sleep(3)        
...
#	driver.execute_script("window.scroll(0,0)","")
	...
	result = driver.title
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','SoftwareSubscription_VerifyLinks10_p16')
        time.sleep(3)        
	...
	result = driver.title
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','SoftwareSubscription_VerifyLinks10_p17')
        time.sleep(3)
...
if __name__ == '__main__':
    ...
    testunit.addTest(FastPass_Mobile("test_Case_SoftwareSubscription_VerifyLinks10"))
    filename="C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\"+now+" FastPass_Test_Case_SoftwareSubscription_VerifyLinks10.html"
    fp=file(filename,'wb')
    runner = HTMLTestRunner.HTMLTestRunner(stream=fp,title='FastPass_Mobile Test Case',description='This is SoftwareSubscription_VerifyLinks10 test case')
    runner.run(testunit)
