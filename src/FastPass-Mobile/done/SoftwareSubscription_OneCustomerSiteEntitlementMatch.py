...
class FastPass_Mobile(unittest.TestCase):
	...
	C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','SoftwareSubscription_OneCustomerSiteEntitlementMatch_p1')
	time.sleep(3)
	...
	C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','SoftwareSubscription_OneCustomerSiteEntitlementMatch_p2')
	...
	driver.implicitly_wait(10)
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','SoftwareSubscription_OneCustomerSiteEntitlementMatch_p3')
        time.sleep(3)
	...
	driver.implicitly_wait(10)
        ...
        assert result == 'FastPass | Entitlements - Customer site entitlement information' ,"The page did not be opened correct"
        assert 'Passport Advantage' in driver.page_source,"The page did not be opened correct"
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','SoftwareSubscription_OneCustomerSiteEntitlementMatch_p4')
        time.sleep(3)
	...
	driver.implicitly_wait(10)
        ...
        assert result == 'FastPass | Entitlements - Customer site entitlement information' ,"The page did not be opened correct"
        assert 'Passport Advantage' in driver.page_source,"The page did not be opened correct"
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','SoftwareSubscription_OneCustomerSiteEntitlementMatch_p5')
        time.sleep(3)
	...
	driver.implicitly_wait(10)
        ...
        assert result == 'FastPass | Entitlements - Customer site entitlement information' ,"The page did not be opened correct"
        assert 'Passport Advantage' in driver.page_source,"The page did not be opened correct"
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','SoftwareSubscription_OneCustomerSiteEntitlementMatch_p6')
        time.sleep(3)
	...
	driver.implicitly_wait(10)
        ...
        assert result == 'FastPass | Entitlements - Customer site entitlement information' ,"The page did not be opened correct"
        assert 'Passport Advantage' in driver.page_source,"The page did not be opened correct"
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','SoftwareSubscription_OneCustomerSiteEntitlementMatch_p7')
        time.sleep(3)
	...
	driver.implicitly_wait(10)
        ...
        assert result == 'FastPass | Entitlements - Customer site entitlement information' ,"The page did not be opened correct"
        assert 'Passport Advantage' in driver.page_source,"The page did not be opened correct"
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','SoftwareSubscription_OneCustomerSiteEntitlementMatch_p8')
        time.sleep(3)
...
if __name__ == '__main__':
    ...
    testunit.addTest(FastPass_Mobile("test_Case_SoftwareSubscription_OneCustomerSiteEntitlementMatch"))
    filename="C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\"+now+" FastPass_Test_Case_SoftwareSubscription_OneCustomerSiteEntitlementMatch.html"
    fp=file(filename,'wb')
    runner = HTMLTestRunner.HTMLTestRunner(stream=fp,title='FastPass_Mobile Test Case',description='This is SoftwareSubscription_OneCustomerSiteEntitlementMatch test case')
    runner.run(testunit)
