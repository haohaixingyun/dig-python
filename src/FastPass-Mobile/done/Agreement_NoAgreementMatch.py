...
class FastPass_Mobile(unittest.TestCase):
	...
	C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','Agreement_NoAgreementMatch_p1')
	time.sleep(3)
	...
	C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','Agreement_NoAgreementMatch_p2')
	...
	driver.implicitly_wait(10)
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','Agreement_NoAgreementMatch_p3')
        time.sleep(3)
	...
	driver.implicitly_wait(10)
        ...
        assert result == 'FastPass | Agreements - Agreement search information' ,"The page did not be opened correct"
        assert 'No results were found that match the search criteria.' in driver.page_source ,"The page did not be opened correct"
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','Agreement_NoAgreementMatch_p4')
        time.sleep(3)
	...
	driver.implicitly_wait(10)
        ...
        assert result == 'FastPass | Agreements - Agreement search information' ,"The page did not be opened correct"
        assert 'No results were found that match the search criteria.' in driver.page_source ,"The page did not be opened correct"
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','Agreement_NoAgreementMatch_p5')
        time.sleep(3)
	...
	driver.implicitly_wait(10)
        ...
        assert result == 'FastPass | Agreements - Agreement search information' ,"The page did not be opened correct"
        assert 'No results were found that match the search criteria.' in driver.page_source ,"The page did not be opened correct"
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','Agreement_NoAgreementMatch_p6')
        time.sleep(3)
	...
	driver.implicitly_wait(10)
        ...
        assert result == 'FastPass | Agreements - Agreement search information' ,"The page did not be opened correct"
        assert 'No results were found that match the search criteria.' in driver.page_source ,"The page did not be opened correct"
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','Agreement_NoAgreementMatch_p7')
        time.sleep(3)
	...
	print "\n"
	print "step13.Input 'site number' field with '7023462' and click 'Search'."
	driver.find_element_by_id("site").clear()
	driver.find_element_by_id("site").send_keys("7023462")
	time.sleep(1)
	driver.find_element_by_id("All_sites").click()
	time.sleep(1)
	driver.execute_script("window.scrollBy(0,document.body.scrollHeight)","")
	...
	driver.implicitly_wait(10)
        ...
        assert result == 'FastPass | Agreements - Agreement search information' ,"The page did not be opened correct"
        assert 'No results were found that match the search criteria.' in driver.page_source ,"The page did not be opened correct"
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','Agreement_NoAgreementMatch_p8')
        time.sleep(3)
...
if __name__ == '__main__':
    ...
    testunit.addTest(FastPass_Mobile("test_Case_Agreement_NoAgreementMatch"))
    filename="C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\"+now+" FastPass_Test_Case_Agreement_NoAgreementMatch.html"
    fp=file(filename,'wb')
    runner = HTMLTestRunner.HTMLTestRunner(stream=fp,title='FastPass_Mobile Test Case',description='This is Agreement_NoAgreementMatch test case')
    runner.run(testunit)
