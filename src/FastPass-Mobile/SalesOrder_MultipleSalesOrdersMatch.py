...
class FastPass_Mobile(unittest.TestCase):
	...
	C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','SalesOrder_MultipleSalesOrdersMatch_p1')
	time.sleep(3)
	...
	C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','SalesOrder_MultipleSalesOrdersMatch_p2')
	...
	driver.implicitly_wait(10)
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','SalesOrder_MultipleSalesOrdersMatch_p3')
        time.sleep(3)
	...
	driver.implicitly_wait(10)
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','SalesOrder_MultipleSalesOrdersMatch_p4')
        time.sleep(3)
	...
	driver.find_element_by_xpath("(//a[contains(text(),'Caja de Retiros, Jubilaciones YPensiones de La Policia Federal')])[1]").click()
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','SalesOrder_MultipleSalesOrdersMatch_p5')
        time.sleep(3)
...
#	time.sleep(1)		
	driver.find_element_by_xpath("(//a[contains(text(),'133774')])[1]").click()
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','SalesOrder_MultipleSalesOrdersMatch_p6')
        time.sleep(3)
...
#	time.sleep(1)		
	driver.find_element_by_xpath("(//a[contains(text(),'7540861')])[1]").click()
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','SalesOrder_MultipleSalesOrdersMatch_p7')
        time.sleep(3)        
...
#	time.sleep(1)		
	driver.find_element_by_xpath("(//a[contains(text(),'0040482058')])[1]").click()
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','SalesOrder_MultipleSalesOrdersMatch_p8')
        time.sleep(3)        
...
if __name__ == '__main__':
    ...
    testunit.addTest(FastPass_Mobile("test_Case_SalesOrder_MultipleSalesOrdersMatch"))
    filename="C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\"+now+" FastPass_Test_Case_SalesOrder_MultipleSalesOrdersMatch.html"
    fp=file(filename,'wb')
    runner = HTMLTestRunner.HTMLTestRunner(stream=fp,title='FastPass_Mobile Test Case',description='This is SalesOrder_MultipleSalesOrdersMatch test case')
    runner.run(testunit)
