...
class FastPass_Mobile(unittest.TestCase):
	...
	C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','NewRealease_VOctober_SalesOrder_04_p1')
	...
	C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\image\\','NewRealease_VOctober_SalesOrder_04_p2')
...
if __name__ == '__main__':
    ...
    testunit.addTest(FastPass_Mobile("test_Case_NewRealease_VOctober_SalesOrder_04"))
    filename="C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Mobile\\result\\"+now+" FastPass_Test_Case_NewRealease_VOctober_SalesOrder_04.html"
    fp=file(filename,'wb')
    runner = HTMLTestRunner.HTMLTestRunner(stream=fp,title='FastPass_Mobile Test Case',description='This is NewRealease_VOctober_SalesOrder_04 test case')
    runner.run(testunit)
