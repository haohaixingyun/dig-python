...
class FastPass_Agile(unittest.TestCase):
	...
	C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','SoftwareSubscription_MultipleCustomerSiteEntitlementMatch_p1')
	...
	C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','SoftwareSubscription_MultipleCustomerSiteEntitlementMatch_p2')
	...
	driver.implicitly_wait(10)
        ...
        assert '1-100' in driver.page_source ,"The data is not avalible"
...
if __name__ == '__main__':
    ...
    testunit.addTest(FastPass_Agile("test_Case_SoftwareSubscription_MultipleCustomerSiteEntitlementMatch"))
    filename="C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\"+now+" FastPass_Test_Case_SoftwareSubscription_MultipleCustomerSiteEntitlementMatch.html"
    fp=file(filename,'wb')
    runner = HTMLTestRunner.HTMLTestRunner(stream=fp,title='FastPass_Agile Test Case',description='This is SoftwareSubscription_MultipleCustomerSiteEntitlementMatch test case')
    runner.run(testunit)
