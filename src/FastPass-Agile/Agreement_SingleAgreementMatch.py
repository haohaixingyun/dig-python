...
class FastPass_Agile(unittest.TestCase):
	...
	C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','Agreement_SingleAgreementMatch_p1')
	time.sleep(3)
	...
	C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','Agreement_SingleAgreementMatch_p2')
	...
	driver.implicitly_wait(10)
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','Agreement_SingleAgreementMatch_p3')
        time.sleep(3)
	...
	print "step4.Click on 'All sites' in the related links area."
        ...
        result = driver.title
        assert result == 'FastPass | Agreements - Agreement details' ,"The page did not be opened correct"
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','Agreement_SingleAgreementMatch_p5')        
	time.sleep(3)
	...
	print "step5.Click on 'Originating site' in the related links area."
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','Agreement_SingleAgreementMatch_p6')        
	time.sleep(3)	
	...
	print "step6.Click on 'Maintenance entitlements' in the related links area."
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','Agreement_SingleAgreementMatch_p7')        
	time.sleep(3)
	...
	print "step7.Click on 'Maintenance entitlements' in the related links area."
        ...
        result = driver.title
        assert result == 'FastPass | Agreements - Agreement details' ,"The page did not be opened correct"
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','Agreement_SingleAgreementMatch_p8')        
	time.sleep(3)        
...
#	driver.execute_script("window.scrollBy(0,document.body.scrollHeight)","")
	driver.execute_script("window.scrollBy(0,200)","")
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','Agreement_SingleAgreementMatch_p9')        
	time.sleep(3)
...
#	driver.execute_script("window.scrollBy(0,1200)","")
        ...
        result = driver.title
        assert result == 'FastPass | Agreements - Agreement details' ,"The page did not be opened correct"
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','Agreement_SingleAgreementMatch_p10')        
	time.sleep(3)     
...
#	driver.execute_script("window.scrollBy(0,document.body.scrollHeight)","")
	...
	time.sleep(1)
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','Agreement_SingleAgreementMatch_p11')        
	time.sleep(3)
...
#	driver.execute_script("window.scrollBy(0,1200)","")
        ...
        result = driver.title
        assert result == 'FastPass | Agreements - Agreement details' ,"The page did not be opened correct"
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','Agreement_SingleAgreementMatch_p12')        
	time.sleep(3)
...
#	driver.execute_script("window.scrollBy(0,document.body.scrollHeight)","")
	...
	time.sleep(1)
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','Agreement_SingleAgreementMatch_p13')        
	time.sleep(3)
...
#	driver.execute_script("window.scrollBy(0,1200)","")
        ...
        result = driver.title
        assert result == 'FastPass | Agreements - Agreement details' ,"The page did not be opened correct"
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','Agreement_SingleAgreementMatch_p14')        
	time.sleep(3)
...
#	driver.execute_script("window.scrollBy(0,document.body.scrollHeight)","")
	...
	time.sleep(1)	
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','Agreement_SingleAgreementMatch_p15')        
	time.sleep(3)
...
#	driver.execute_script("window.scrollBy(0,200)","")
	time.sleep(1)	
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','Agreement_SingleAgreementMatch_p16')        
	time.sleep(3)
	...
	driver.implicitly_wait(10)
        ...
        result = driver.title
        assert result == 'FastPass | Agreements - Agreement details' ,"The page did not be opened correct"
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','Agreement_SingleAgreementMatch_p17')
        time.sleep(3)
	...
	driver.implicitly_wait(10)
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','Agreement_SingleAgreementMatch_p18')
        time.sleep(3)
	...
	driver.implicitly_wait(10)
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','Agreement_SingleAgreementMatch_p19')
        time.sleep(3)
	...
	driver.implicitly_wait(10)
        ...
        result = driver.title
        assert result == 'FastPass | Agreements - Agreement search information - Default sort by customer name' ,"The page did not be opened correct"
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','Agreement_SingleAgreementMatch_p20')
        time.sleep(3)
	...
	driver.implicitly_wait(10)
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','Agreement_SingleAgreementMatch_p21')
        time.sleep(3)
	...
	driver.implicitly_wait(10)
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','Agreement_SingleAgreementMatch_p22')
        time.sleep(3)
...
if __name__ == '__main__':
    ...
    testunit.addTest(FastPass_Agile("test_Case_Agreement_SingleAgreementMatch"))
    filename="C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\"+now+" FastPass_Test_Case_Agreement_SingleAgreementMatch.html"
    fp=file(filename,'wb')
    runner = HTMLTestRunner.HTMLTestRunner(stream=fp,title='FastPass_Agile Test Case',description='This is Agreement_SingleAgreementMatch test case')
    runner.run(testunit)
