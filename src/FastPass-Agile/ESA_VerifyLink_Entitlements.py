...
class FastPass_Agile(unittest.TestCase):
	...
	C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','ESA_VerifyLink_Entitlements_p1')
	...
	C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','ESA_VerifyLink_Entitlements_p2')
...
#	driver.execute_script("window.scrollBy(0,document.body.scrollHeight)","")
	...
	driver.implicitly_wait(10)
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','ESA_VerifyLink_Entitlements_p3')
        time.sleep(3)
	...
	assert result == 'FastPass | Agreements - Agreement site information' ,"The page did not be opened correct"
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','ESA_VerifyLink_Entitlements_p4')
        time.sleep(3)
	...
	result = driver.title
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','ESA_VerifyLink_Entitlements_p5')
        time.sleep(3)
	...
	result = driver.title
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','ESA_VerifyLink_Entitlements_p6')
        time.sleep(3)
	...
	assert result == 'FastPass | Entitlements - Active entitlements for site - Default sort by end date' ,"The page did not be opened correct"
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','ESA_VerifyLink_Entitlements_p7')
        time.sleep(3)
	...
	result = driver.title
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','ESA_VerifyLink_Entitlements_p8')
        time.sleep(3)
	...
	result = driver.title
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','ESA_VerifyLink_Entitlements_p9')
        time.sleep(3)
...
#	driver.execute_script("window.scrollBy(0,200)","")
	...
	result = driver.title
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','ESA_VerifyLink_Entitlements_p10')
        time.sleep(3)
...
#	driver.execute_script("window.scrollBy(0,200)","")
	...
	result = driver.title
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','ESA_VerifyLink_Entitlements_p11')
        time.sleep(3)
...
#	driver.execute_script("window.scrollBy(0,1000)","")
	...
	result = driver.title
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','ESA_VerifyLink_Entitlements_p12')
        time.sleep(3)
...
#	driver.execute_script("window.scrollBy(0,1000)","")
	...
	result = driver.title
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','ESA_VerifyLink_Entitlements_p13')
        time.sleep(3)
...
#	driver.execute_script("window.scrollBy(0,1000)","")
	...
	result = driver.title
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','ESA_VerifyLink_Entitlements_p14')
        time.sleep(3)
...
if __name__ == '__main__':
    ...
    testunit.addTest(FastPass_Agile("test_Case_ESA_VerifyLink_Entitlements"))
    filename="C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\"+now+" FastPass_Test_Case_ESA_VerifyLink_Entitlements.html"
    fp=file(filename,'wb')
    runner = HTMLTestRunner.HTMLTestRunner(stream=fp,title='FastPass_Agile Test Case',description='This is ESA_VerifyLink_Entitlements test case')
    runner.run(testunit)
