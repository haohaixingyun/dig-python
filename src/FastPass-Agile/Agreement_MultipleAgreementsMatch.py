...
class FastPass_Agile(unittest.TestCase):
	...
	C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','Agreement_MultipleAgreementsMatch_p1')
	...
	C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','Agreement_MultipleAgreementsMatch_p2')
	...
	driver.implicitly_wait(10)
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','Agreement_MultipleAgreementsMatch_p3')
        time.sleep(3)
        ...
        time.sleep(3)
        driver.find_element_by_xpath("(//a[contains(text(),'11531')])[8]").click()
        time.sleep(5)
        result = driver.title
        assert result == 'FastPass | Agreements - Agreement details' ,"The page did not be opened correct"
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','Agreement_MultipleAgreementsMatch_p4')
        time.sleep(3)
        ...
        #time.sleep(3)
        driver.find_element_by_xpath("(//a[contains(text(),'7084912')])[1]").click()
        time.sleep(8)
        result = driver.title
        assert result == 'FastPass | Customers - Customer details' ,"The page did not be opened correct"
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','Agreement_MultipleAgreementsMatch_p5')
        time.sleep(3)
        ...
        driver.implicitly_wait(10)
        time.sleep(3)
        driver.find_element_by_link_text("ING (US) Financial Services Corp").click()
        time.sleep(3)
        result = driver.title
        assert result == 'FastPass | Agreements - Agreement site information' ,"The page did not be opened correct"
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','Agreement_MultipleAgreementsMatch_p6')
        time.sleep(3)
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','Agreement_MultipleAgreementsMatch_p7')
        time.sleep(3)
	...
	time.sleep(5)
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','Agreement_MultipleAgreementsMatch_p8')
        time.sleep(3)        
	...
	time.sleep(5)
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','Agreement_MultipleAgreementsMatch_p9')
        time.sleep(3)          
	...
	time.sleep(5)
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','Agreement_MultipleAgreementsMatch_p10')
        time.sleep(3)
	...
	time.sleep(5)
        ...
        #time.sleep(3)
        driver.find_element_by_link_text("7084912").click()
        time.sleep(3)
        result = driver.title
        assert result == 'FastPass | Customers - Customer details' ,"The page did not be opened correct"
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','Agreement_MultipleAgreementsMatch_p11')
        time.sleep(3)
        ...
        #driver.execute_script("window.scrollBy(0,500)","")
        #time.sleep(3)
        driver.find_element_by_xpath("//a[@href='/software/xl/fastpass/agile/fastpass.nsf/agreements?openform']").click()
        time.sleep(3)
        result = driver.title
        assert result == 'FastPass | Agreements - Agreement search' ,"The page did not be opened correct"
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','Agreement_MultipleAgreementsMatch_p12')
        time.sleep(3)
	...
	driver.implicitly_wait(10)
        ...
        result = driver.title
        assert result == 'FastPass | Agreements - Agreement search information - Default sort by customer name' ,"The page did not be opened correct"
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','Agreement_MultipleAgreementsMatch_p13')
        time.sleep(3)
	...
	driver.implicitly_wait(10)
        ...
        result = driver.title
        assert result == 'FastPass | Agreements - Agreement search information - Default sort by customer name' ,"The page did not be opened correct"
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','Agreement_MultipleAgreementsMatch_p14')
        time.sleep(3)
	...
	driver.implicitly_wait(10)
        ...
        result = driver.title
        assert result == 'FastPass | Agreements - Agreement search information - Default sort by customer name' ,"The page did not be opened correct"
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','Agreement_MultipleAgreementsMatch_p15')
        time.sleep(3)
	...
	driver.implicitly_wait(10)
        ...
        result = driver.title
        assert result == 'FastPass | Agreements - Agreement search information - Default sort by customer name' ,"The page did not be opened correct"
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','Agreement_MultipleAgreementsMatch_p16')
        time.sleep(3)
...
if __name__ == '__main__':
    ...
    testunit.addTest(FastPass_Agile("Agreement_MultipleAgreementsMatch"))
    filename="C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\"+now+"FastPass_Test_Case_Agreement_MultipleAgreementsMatch.html"
    fp=file(filename,'wb')
    runner = HTMLTestRunner.HTMLTestRunner(stream=fp,title='FastPass_Agile Test Case',description='This is FastPass_Test_Case_Agreement_MultipleAgreementsMatch test case')
    runner.run(testunit)
