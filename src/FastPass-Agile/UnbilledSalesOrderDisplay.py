...
if __name__ == '__main__':
    ...
    testunit.addTest(FastPass_Agile("test_Case_UnbilledSalesOrderDisplay"))
    filename="C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\"+now+" FastPass_Test_Case_UnbilledSalesOrderDisplay.html"
    fp=file(filename,'wb')
    runner = HTMLTestRunner.HTMLTestRunner(stream=fp,title='FastPass_Agile Test Case',description='This is UnbilledSalesOrderDisplay test case')
    runner.run(testunit)
