...
class FastPass_Agile(unittest.TestCase):
	...
	C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','SalesOrder_NoSalesOrdersMatch_p1')
	time.sleep(3)
	...
	C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','SalesOrder_NoSalesOrdersMatch_p2')
	...
	driver.implicitly_wait(10)
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','SalesOrder_NoSalesOrdersMatch_p3')
        time.sleep(3)
	...
	driver.implicitly_wait(10)
        ...
        assert 'No results were found that match the search criteria.' in driver.page_source,"The page did not be opened correct"        
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','SalesOrder_NoSalesOrdersMatch_p4')
        time.sleep(3)
...
#	time.sleep(1)		
	...
	driver.implicitly_wait(10)
        ...
        assert 'No results were found that match the search criteria.' in driver.page_source,"The page did not be opened correct"        
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','SalesOrder_NoSalesOrdersMatch_p5')
        time.sleep(3)
...
if __name__ == '__main__':
    ...
    testunit.addTest(FastPass_Agile("test_Case_SalesOrder_NoSalesOrdersMatch"))
    filename="C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\"+now+" FastPass_Test_Case_SalesOrder_NoSalesOrdersMatch.html"
    fp=file(filename,'wb')
    runner = HTMLTestRunner.HTMLTestRunner(stream=fp,title='FastPass_Agile Test Case',description='This is SalesOrder_NoSalesOrdersMatch test case')
    runner.run(testunit)
