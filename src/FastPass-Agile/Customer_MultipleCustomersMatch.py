...
class FastPass_Agile(unittest.TestCase):
	...
	C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','Customer_MultipleCustomersMatch_p1')
	...
	C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','Customer_MultipleCustomersMatch_p2')
	...
	driver.implicitly_wait(10)
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','Customer_MultipleCustomersMatch_p3')
        time.sleep(3)
	...
	result = driver.title
        ...
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','Customer_MultipleCustomersMatch_p4')
	time.sleep(3)	
...
#	driver.execute_script("window.scrollBy(0,100)","")
	...
	driver.implicitly_wait(10)
        time.sleep(3)
        result = driver.title
        assert result == 'FastPass | Customers - Customer information - Default sort by customer name desc' ,"The page did not be opened correct"
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','Customer_MultipleCustomersMatch_p5')
        time.sleep(3)
...
#	driver.execute_script("window.scrollBy(0,100)","")
	...
	driver.implicitly_wait(10)
        ...
        result = driver.title
        assert result == 'FastPass | Customers - Customer information - Default sort by customer name desc' ,"The page did not be opened correct"
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','Customer_MultipleCustomersMatch_p6')
        time.sleep(3)
...
#	driver.execute_script("window.scrollBy(0,100)","")
	...
	time.sleep(3)
	result = driver.title
        assert result == 'FastPass | Customers - Customer information - Default sort by site number' ,"The page did not be opened correct"
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','Customer_MultipleCustomersMatch_p7')
        time.sleep(3)
...
#	driver.execute_script("window.scrollBy(0,100)","")
	...
	time.sleep(3)
	result = driver.title
        assert result == 'FastPass | Customers - Customer information - Default sort by country' ,"The page did not be opened correct"
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','Customer_MultipleCustomersMatch_p8')
        time.sleep(3)
...
#	driver.execute_script("window.scrollBy(0,100)","")
	...
	time.sleep(3)
	result = driver.title
        assert result == 'FastPass | Customers - Customer information - Default sort by country desc' ,"The page did not be opened correct"
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','Customer_MultipleCustomersMatch_p9')
        time.sleep(3)
...
#	driver.execute_script("window.scrollBy(0,100)","")
	...
	result = driver.title
        assert result == 'FastPass | Customers - Customer information - Default sort by customer name' ,"The page did not be opened correct"
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','Customer_MultipleCustomersMatch_p10')
        time.sleep(3)
...
#	driver.execute_script("window.scrollBy(0,100)","")
	...
	result = driver.title
        assert result == 'FastPass | Customers - Customer information - Default sort by customer name' ,"The page did not be opened correct"
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','Customer_MultipleCustomersMatch_p11')
        time.sleep(3)
...
#	driver.execute_script("window.scrollBy(0,100)","")
	...
	result = driver.title
        assert result == 'FastPass | Customers - Customer information - Default sort by customer name' ,"The page did not be opened correct"
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','Customer_MultipleCustomersMatch_12')
        time.sleep(3)
...
#	driver.execute_script("window.scrollBy(0,100)","")
	...
	result = driver.title
        assert result == 'FastPass | Customers - Customer information - Default sort by customer name' ,"The page did not be opened correct"
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','Customer_MultipleCustomersMatch_p13')
        time.sleep(3)
...
#	driver.execute_script("window.scrollBy(0,100)","")
	...
	result = driver.title
        assert result == 'FastPass | Customers - Customer information - Default sort by customer name' ,"The page did not be opened correct"
        C_screenshots.C_screenshots(self,'C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\image\\','Customer_MultipleCustomersMatch_p14')
        time.sleep(3)
...
if __name__ == '__main__':
    ...
    testunit.addTest(FastPass_Agile("test_Case_Customer_MultipleCustomersMatch"))
    filename="C:\LM_IBM_WORK\LM_WORK\FastPass\FastPass_Agile\\result\\"+now+" FastPass_Test_Case_Customer_MultipleCustomersMatch.html"
    fp=file(filename,'wb')
    runner = HTMLTestRunner.HTMLTestRunner(stream=fp,title='FastPass_Agile Test Case',description='This is Customer_MultipleCustomersMatch test case')
    runner.run(testunit)
