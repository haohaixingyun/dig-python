 ...
 *		object: the name of the object of select type(defined by user in xml's)
 *		value: selected item
 *  14. execute query for DB | added by kevin.huangfu
 *  "db2_execute_query"
 *   object: sql 
 *   value: tablename
 * ************************************************
...
public class Verify extends ActionBase {
	 ...
	 */
	public Verify(Object object, Object param, Object extParam,TestCase.Step step,Object... args) {
		super(object, param, extParam,step,args);
		// TODO Auto-generated constructor stub
	}
	public static String odsResult = "";
	public void doAction(Object object, Object param, Object extParam,Object... args) {}
	public void doAction(Object object, Object param, Object rootObj,TestCase.Step step,Object... args) {
		if (object instanceof TestCase.Verification) {
			...
			if (verType.equalsIgnoreCase("string_in_page")) {
			    resultInt = VerifyImp.verifyStringInPage(ver.getObject(),ver.getValue(),rootObj,step);
			...
			} else if (verType.equalsIgnoreCase("db2_execute_query")){
				resultInt = VerifyImp.verifyExecuteQuery(ver.getObject(),ver.getValue(),ver.getParam());
				odsResult = VerifyImp.odsResult;
			}
