...
public class TestCase  {
	...
	public static final class Step {
		...
		private int stepResult = IResult.PASSED;
	...
	public void setStepResult (int stepIndex, int stepResult) {
		((Step)(steps.get(stepIndex))).setResult(stepResult);
	}
