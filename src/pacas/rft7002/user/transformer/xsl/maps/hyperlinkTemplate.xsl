<xsl:stylesheet version='1.0'
	...
	<xsl:template name="hyperlinkTemplate">
	  ...
	  <xsl:param name="paramValue">default</xsl:param><xsl:text>
</xsl:text><qtpRep:Object qtpRep:Class="Link" qtpRep:Name="{$paramName}"><xsl:text>
</xsl:text>
<qtpRep:Properties><xsl:text>
</xsl:text>
<qtpRep:Property qtpRep:Name="micclass" qtpRep:Hidden="1" qtpRep:ReadOnly="1" qtpRep:Type="STRING">	<qtpRep:Value qtpRep:RegularExpression="0">Link</qtpRep:Value></qtpRep:Property><xsl:text>
</xsl:text>
<qtpRep:Property qtpRep:Name="text" qtpRep:Hidden="0" qtpRep:ReadOnly="0" qtpRep:Type="STRING">	<qtpRep:Value qtpRep:RegularExpression="0"><xsl:value-of select="$paramValue"/></qtpRep:Value></qtpRep:Property><xsl:text>
</xsl:text>
<qtpRep:Property qtpRep:Name="html tag" qtpRep:Hidden="0" qtpRep:ReadOnly="0" qtpRep:Type="STRING">	<qtpRep:Value qtpRep:RegularExpression="0">A</qtpRep:Value>	</qtpRep:Property><xsl:text>
</xsl:text>
</qtpRep:Properties><xsl:text>
</xsl:text>
