...
<qtpRep:Property qtpRep:Name="type" qtpRep:Hidden="0" qtpRep:ReadOnly="0" qtpRep:Type="STRING">	<qtpRep:Value qtpRep:RegularExpression="0">text</qtpRep:Value>	</qtpRep:Property><xsl:text>
</xsl:text>
