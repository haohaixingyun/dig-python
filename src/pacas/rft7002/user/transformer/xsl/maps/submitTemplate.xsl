<xsl:stylesheet version='1.0'
	...
	<xsl:template name="submitTemplate">
	  <xsl:param name="paramPropertyName">1</xsl:param>
	  <xsl:param name="paramName">default</xsl:param>
	  <xsl:param name="paramValue">default</xsl:param>
	  <xsl:param name="paramIndex">1</xsl:param><xsl:text>
</xsl:text><qtpRep:Object qtpRep:Class="WebButton" qtpRep:Name="{$paramName}"><xsl:text>
</xsl:text>
<qtpRep:Properties><xsl:text>
</xsl:text>
<qtpRep:Property qtpRep:Name="micclass" qtpRep:Hidden="1" qtpRep:ReadOnly="1" qtpRep:Type="STRING">	<qtpRep:Value qtpRep:RegularExpression="0">WebButton</qtpRep:Value>	</qtpRep:Property><xsl:text>
</xsl:text>
<qtpRep:Property qtpRep:Name="value" qtpRep:Hidden="1" qtpRep:ReadOnly="1" qtpRep:Type="STRING">	<qtpRep:Value qtpRep:RegularExpression="0"><xsl:value-of select="$paramValue"/></qtpRep:Value>	</qtpRep:Property><xsl:text>
</xsl:text>
<qtpRep:Property qtpRep:Name="type" qtpRep:Hidden="0" qtpRep:ReadOnly="0" qtpRep:Type="STRING">	<qtpRep:Value qtpRep:RegularExpression="0">submit</qtpRep:Value>	</qtpRep:Property><xsl:text>
</xsl:text>
